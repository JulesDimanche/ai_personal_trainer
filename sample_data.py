...
def insert_workout_plan(user_id,workout_data):
    try:
        ...
        update_daily_progress(user_id,datetime.datetime.utcnow())
        handle_wo_summary_trigger(user_id,workout_data.get("summary",{}),datetime.datetime.utcnow())
        return str(result.inserted_id)
    except Exception as e:
        print(f"Error inserting macro plan: {e}")
        return None
...
if __name__=='__main__':
    ...
    #print("calore Plan-------")
    #print(diet)
    workout_data=generate_workout_summary('I made 3 sets of 10, 8, and 6 reps of incline bench press at 60kg.',os.getenv("QWEN3_API_KEY"))
